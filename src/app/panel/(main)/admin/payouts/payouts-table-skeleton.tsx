...
interface PayoutsTableSkeletonProps {
	pageSize?: number;
}

export function PayoutsTableSkeleton({ pageSize = 10 }: PayoutsTableSkeletonProps) {
	return (
			...
			<Card className="p-4">
				<div className="flex flex-col gap-4">
					<div className="flex flex-wrap items-center gap-3">
						<Skeleton className="h-10 w-full sm:grow rounded-lg" />
						<Skeleton className="h-10 w-full sm:grow rounded-lg" />
