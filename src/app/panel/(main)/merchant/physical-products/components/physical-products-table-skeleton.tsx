...
interface PhysicalProductsTableSkeletonProps {
	pageSize?: number;
}

export function PhysicalProductsTableSkeleton({ pageSize = 10 }: PhysicalProductsTableSkeletonProps) {
	return (
						...
						<table className="w-full min-w-250">
							<thead>
								<tr className="border-b border-muted-foreground/10">
									...
									<th className="p-3 text-left text-sm font-medium text-muted">Estoque</th>
