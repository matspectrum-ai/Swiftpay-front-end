...
interface DigitalProductsTableSkeletonProps {
	pageSize?: number;
}

export function DigitalProductsTableSkeleton({ pageSize = 10 }: DigitalProductsTableSkeletonProps) {
	return (
						...
						<table className="w-full min-w-200">
							<thead>
								<tr className="border-b border-muted-foreground/10">
									...
									<th className="p-3 text-left text-sm font-medium text-muted">Produto</th>
									...
									<th className="p-3 text-left text-sm font-medium text-muted">Itens Digitais</th>
